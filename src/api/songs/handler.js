...
class SongsHandler {
  constructor(service, validator) {
    ...
    this.putSongByIdHanlder = this.putSongByIdHanlder.bind(this);
    this.deleteSongByIdHanlder = this.deleteSongByIdHanlder.bind(this);
  }
  ...
  async deleteSongByIdHanlder(request, h) {
    try {
      const { id } = request.params;
